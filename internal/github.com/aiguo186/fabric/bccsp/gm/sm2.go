...
func MarshalSM2Signature(r, s *big.Int) ([]byte, error) {
	//fmt.Println("wcx Debug: [C:\\Go\\src\\gm-fabric-goclient\\vendor\\github.com\\hyperledger\\fabric-sdk-go\\internal\\github.com\\hyperledger\\fabric\\bccsp\\gm\\sm2.go] \n'MarshalSM2Signature' runing ")
	return asn1.Marshal(SM2Signature{r, s})
}

func UnmarshalSM2Signature(raw []byte) (*big.Int, *big.Int, error) {
	//fmt.Println("wcx Debug: [C:\\Go\\src\\gm-fabric-goclient\\vendor\\github.com\\hyperledger\\fabric-sdk-go\\internal\\github.com\\hyperledger\\fabric\\bccsp\\gm\\sm2.go] \n'UnmarshalSM2Signature' runing ")
	// Unmarshal
...
func (s *gmsm2Signer) Sign(k bccsp.Key, digest []byte, opts bccsp.SignerOpts) (signature []byte, err error) {
	//fmt.Println("wcx Debug: [C:\\Go\\src\\gm-fabric-goclient\\vendor\\github.com\\hyperledger\\fabric-sdk-go\\internal\\github.com\\hyperledger\\fabric\\bccsp\\gm\\sm2.go] \n'Sign 1' runing ")
	//fmt.Println("wcx Debug:",k.(*gmsm2PrivateKey).privKey.D)
	//fmt.Println("wcx Debug:",digest)
	//fmt.Println("wcx Debug:",opts)
	t,err := signGMSM2(k.(*gmsm2PrivateKey).privKey, digest, opts)
