...
func SignDataToSignDigit(sign []byte) (*big.Int, *big.Int, error) {
	//fmt.Println("wcx Debug: [C:\\Go\\src\\gm-fabric-goclient\\vendor\\github.com\\hyperledger\\fabric-sdk-go\\internal\\github.com\\tjfoc\\gmsm\\sm2\\sm2.go] \n'SignDataToSignDigit' runing ")
...
func (priv *PrivateKey) Sign(rand io.Reader, msg []byte, opts crypto.SignerOpts) ([]byte, error) {
	//fmt.Println("wcx Debug: [C:\\Go\\src\\gm-fabric-goclient\\vendor\\github.com\\hyperledger\\fabric-sdk-go\\internal\\github.com\\tjfoc\\gmsm\\sm2\\sm2.go] \n'Sign 1' runing ")
	//fmt.Println("wcx Debug:",priv.D.String())
	//fmt.Println("wcx Debug: ",msg)
	//fmt.Println("wcx Debug:",opts)

	r, s, err := Sign(rand,priv, msg)  //rand wcx add.我们自己国密代码中有rand
	if err != nil {
		return nil, err
	}
	t,err:= asn1.Marshal(sm2Signature{r, s})
	//fmt.Println("wcx Debug:t=",t)
	return t,err
}
