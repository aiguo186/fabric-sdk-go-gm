...
import (
	...
	"github.com/aiguo186/fabric-sdk-go-gm/internal/github.com/tjfoc/gmsm/sm3"
...
func parsePublicKey(algo PublicKeyAlgorithm, keyData *publicKeyInfo) (interface{}, error) {
	...
	case ECDSA:
		...
		//tmp := oidNamedCurveP256SM2   //oidNamedCurveP256SM2 = asn1.ObjectIdentifier{1, 2, 156, 10197, 1, 301}
		//namedCurveOID := &tmp

		namedCurve := namedCurveFromOID(*namedCurveOID)
		if namedCurve == nil {
			//fmt.Println("wcx Info: x509: unsupported elliptic curve---------->")
			return nil, errors.New("x509: unsupported elliptic curve")
		}
		x, y := elliptic.Unmarshal(namedCurve, asn1Data)
		if x == nil {
			//fmt.Println("wcx Info: x509: failed to unmarshal elliptic curve point---------->")
			return nil, errors.New("x509: failed to unmarshal elliptic curve point")
		}

		//fmt.Println("wcx Info: tmp---------->",namedCurveOID)
		//fmt.Println("wcx Info: namedCurve--->",namedCurve)
		//fmt.Println("wcx Info: x------------>",x)
		//fmt.Println("wcx Info: y------------>",y)
...
func parseCertificate(in *certificate) (*Certificate, error) {
	...
	//fmt.Println("wcx Debug: 解析证书 完成。和我们自己代码一样。")
	return out, nil
}
