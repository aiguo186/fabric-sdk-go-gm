...
import (
	...
	commtls "github.com/aiguo186/fabric-sdk-go-gm/pkg/core/config/comm/tls"
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/core/config/cryptoutil"
	...
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/util/pathvar"
...
const (
	defaultPeerConnectionTimeout          = time.Second * 120
...
func detectDeprecatedNetworkConfig(endpointConfig *EndpointConfig) {
	...
	for _, v := range endpointConfig.networkConfig.Channels {
		if len(v.Orderers) > 0 {
			...
			logger.Warn("visit https://github.com/aiguo186/fabric-sdk-go-gm/blob/master/test/fixtures/config/overrides/local_entity_matchers.yaml for samples")
			break
		}
	}
}
