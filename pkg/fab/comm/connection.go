...
import (
	...
	fabcontext "github.com/aiguo186/fabric-sdk-go-gm/pkg/common/providers/context"
...
func NewConnection(ctx fabcontext.Client, url string, opts ...options.Opt) (*GRPCConnection, error) {
	if url == "" {
		...
		//fmt.Println("wcx Debug: server URL specified........................")
	}

	params := defaultParams()
	//fmt.Println("wcx Debug: params.connectTimeout........................",params.connectTimeout)
	...
	//fmt.Println("wcx Debug: context.WithTimeout........................")
	reqCtx, cancel := context.NewRequest(ctx, context.WithTimeout(params.connectTimeout))
	//fmt.Println("wcx Debug: context.WithTimeout end")
	defer cancel()
