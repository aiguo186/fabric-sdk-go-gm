...
import (
	...
	credentials "github.com/aiguo186/fabric-sdk-go-gm/internal/github.com/tjfoc/gmtls/gmcredentials"
	...
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/client/common/verifier"
	...
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/core/config/comm"
...
func newPeerEndorser(endorseReq *peerEndorserRequest) (*peerEndorser, error) {
	...
	//fmt.Println("wcx debug:timeout=", timeout)
...
func (p *peerEndorser) ProcessTransactionProposal(ctx reqContext.Context, request fab.ProcessProposalRequest) (*fab.TransactionProposalResponse, error) {
	...
	if err != nil {
		...
		//fmt.Println("wcx Debug: peerendorser.go \n TransactionProposalResponse succeed")
	}
	...
	if err != nil {
		...
		//fmt.Println("wcx Debug: peerendorser.go \n chaincode response status parsing succeed")
	}
