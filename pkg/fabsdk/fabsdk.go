...
import (
	...
	"github.com/aiguo186/fabric-sdk-go-gm/internal/github.com/aiguo186/fabric/core/operations"
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/common/logging"
	coptions "github.com/aiguo186/fabric-sdk-go-gm/pkg/common/options"
	...
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/context"
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/core/config/lookup"
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/core/cryptosuite"
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/core/logging/api"
	fabImpl "github.com/aiguo186/fabric-sdk-go-gm/pkg/fab"
	sdkApi "github.com/aiguo186/fabric-sdk-go-gm/pkg/fabsdk/api"
	"github.com/aiguo186/fabric-sdk-go-gm/pkg/fabsdk/metrics"
	metricsCfg "github.com/aiguo186/fabric-sdk-go-gm/pkg/fabsdk/metrics/cfg"
	mspImpl "github.com/aiguo186/fabric-sdk-go-gm/pkg/msp"
...
func fromPkgSuite(configProvider core.ConfigProvider, pkgSuite pkgSuite, opts ...Option) (*FabricSDK, error) {
	...
	//fmt.Println("coreProv---->", coreProv)
	//fmt.Println("mspProv---->", mspProv)
	//fmt.Println("svc---->", svc)
	//fmt.Println("lg---->", lg)
...
func initSDK(sdk *FabricSDK, configProvider core.ConfigProvider, opts []Option) error { //nolint
	...
	userStore, err := sdk.opts.MSP.CreateUserStore(cfg.identityConfig)   //wcx  读 /tmp/gssx-msp
	if err != nil {
...
func (sdk *FabricSDK) initializeCryptoSuite(cryptoSuiteConfig core.CryptoSuiteConfig) error {
	//fmt.Println("wcx Debug:initializeCryptoSuite  aaaaaaaaaaaaaaaa")
	var err error
	...
	if !cryptosuite.DefaultInitialized() {
		...
		if err != nil {
			...
			//fmt.Println("wcx Debug:succeed to set default crypto suite  aaaaaaaaaaaaaaaa")
		}
	} else {
		//fmt.Println("wcx Debug:default cryptosuite already initialized  aaaaaaaaaaaaaaaa")
